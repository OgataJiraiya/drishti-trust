...
export const fetchAssessmentFindings=(id:string,page:number)=>getJson(`/api/assessments/${encodeURIComponent(id)}/findings?page=${page}&page_size=100`,isEvidenceList);
